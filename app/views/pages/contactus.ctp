		...
		<div class="mainbody2">	
			...
			<form name="orderform" method="post" onsubmit="return validateForm();" action="Submit">
				...
				<tr>
					...
					<td>
						<input class=contactboxes name=date type=date required placeholder="&nbsp;Date">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<div class=contactboxes1><label>Address:<span class="star">*</span></div>
					</td>
					<td>
						<textarea style="max-width: 250px" cols="30" rows="3" class=contactboxes2 name=address type="text" required placeholder="&nbsp;Address"></textarea>
					</td>
				</tr>
				<tr>
					<td>
