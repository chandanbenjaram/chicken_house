	...
	<div class="main">
		...
		<div class="mainbody2">	
			<div id="homeline">
				...
				<table>
					<td id="savemoney">
						<img src="img/off.png" width="150px;"/>
					</td>
					<td id="discount">
						Please show Discount card in counter to get Rs. 5/- Discount on 1kg of chicken or 2kgs of live purchase.
					</td>
				</table>
				<span id="homeline2">Our Products</span><br>
				<table class="hometable1">
					<tr>
						<td>
							<div class="homebox1">
							Skinless<br>
						...
						<td>
							<div class="homebox1">
							Dressing<br>
							<span class="homeimagebox"><img src="img/dressing.jpg"></span><br>
							<a href="ContactUs"><button class="orderbutton">ORDER NOW</button></a>
							</div>
						</td>
						<td>
							<div class="homebox1">
							Boneless<br>
							<span class="homeimagebox"><img src="img/boneless.jpg"></span><br>
							<a href="ContactUs"><button class="orderbutton">ORDER NOW</button></a>
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="homebox1">
							Legs<br>
							<span class="homeimagebox"><img src="img/legs.png"></span><br>
							<a href="ContactUs"><button class="orderbutton">ORDER NOW</button></a>
							</div>
						</td>
						<td>
							<div class="homebox1">
							Wings<br>
							<span class="homeimagebox"><img src="img/wings.jpg"></span><br>
							<a href="ContactUs"><button class="orderbutton">ORDER NOW</button></a>
							</div>
						</td>
						<td>
							<div class="homebox1">
							Frozen Chicken<br>
							<span class="homeimagebox"><img src="img/frozen.png"></span><br>	
							<a href="ContactUs"><button class="orderbutton">ORDER NOW</button></a>
							</div>
						</td>
					</tr>
				...
				<div>
					<table>
						<td>
							...
							Print Discount card and show in counter to get 5rs discount on 1kg of chicken. 
						</td>
						<td>
